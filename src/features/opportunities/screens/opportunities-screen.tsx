  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        {tipo === 'CONTRATANTE' && <TouchableOpacity style={styles.add} onPress={() => setModalAberto(true)}><Ionicons name="add" color={colors.white} size={24} /></TouchableOpacity>}
      </View>
